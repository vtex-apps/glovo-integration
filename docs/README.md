...
3. Go to your Store's Amdmin, on the side menu browse to *Apps -> My Apps*  And look for the "Glovo Integration" Box, click on it.
...
4. (optional) inside your Store's Admin, on the side menu go to *Orders Management -> Settings -> Affiliate* and configure a new [affiliate](https://help.vtex.com/en/tutorial/integration-guide-consuming-catalog-information-for-use-in-an-external-service) as follows:
